...
corrente=0.56;  %0.651843;  %  O valor medido foi de I=0.64A
N_espiras=15;
...
P_centro=[0 0 0];%-(N_espiras-1)*raio_cabo];  %raio_cabo];% % para a bobine ficar à face do plano!
plano_paralelo=1;
...
braco_y=0.20;
    ...
    z=0.08;    %   distancia a qual pretendemos visualizar o corte
...
%                 y=0.00000001;
%             end            
            res=campo_bobine_simula_cecilio(braco_x,braco_y,corrente,[x y z],P_centro,N_espiras,plano_paralelo,raio_cabo*2);
            resultados_xy(k,1)=x;
            resultados_xy(k,2)=y;
            resultados_xy(k,3)=z;
