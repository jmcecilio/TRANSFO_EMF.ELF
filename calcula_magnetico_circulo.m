function B=calcula_magnetico_circulo(a,b,x,y,z,I)
...
F_1 = @(t) (cos(t).^2.*(z-D).^2+sin(t).^2.*(z-D).^2).^(1/2)./((x-R.*cos(t)).^2+(y-R.*sin(t)).^2+(z-D).^2);
...
F_2 = @(t) (-sin(t).*(y-R.*sin(t))-cos(t).*(x-R.*cos(t)))./((x-R.*cos(t)).^2+(y-R.*sin(t)).^2+(z-D).^2);
